        ...
        <section className="bg-hero-gradient text-dark-foreground py-16">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <p className="text-dark-foreground/70 text-lg max-w-2xl">
              Solusi keamanan siber komprehensif untuk melindungi infrastruktur digital organisasi Anda.
            </p>
          </div>
        </section>
            ...
            {services.map((svc, i) => (
              ...
              >
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-sm font-bold uppercase tracking-widest text-muted-foreground mb-2">Overview</h3>
                    <p className="text-foreground/80 leading-relaxed">{svc.overview}</p>
                  </div>

                  <div>
                    <h3 className="text-sm font-bold uppercase tracking-widest text-muted-foreground mb-2">Scope</h3>
                  ...
                  <div>
                    <h3 className="text-sm font-bold uppercase tracking-widest text-muted-foreground mb-2">Deliverables</h3>
                    <ul className="space-y-2">
